...
<body>
    <br>
    <div class="form2">
        <form action="register4.php" method="POST" enctype="multipart/form-data">
            <div class="contenedor">  
             <h2>Registro/Productos</h2>
             <br>
        <div class="hijo_admin">
            <label id="lbl" for="name">ID:</label><br>
        ...
        <div class="hijo_admin">
            <label id="lbl" for="name">Descripcion:</label><br>
            <input type="text" id="desc" name="desc">
        </div>
        <div class="hijo_admin">
            <label id="lbl" for="name">Precio:</label><br>
            <input type="text" id="prec" name="prec">
        </div>
        <br>
        <div class="hijo">
            <button type="submit" class="btn_admin">Registrar</button>
        </div>
    </div>
    </form>
    </div>
